...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['client_id', 'enterprise_id', 'team_id', 'user_id', 'installed_at'], name='slackbot_sl_client__4bacac_idx'),
        ),
        migrations.AddIndex(
            model_name='slackbot',
            index=models.Index(fields=['client_id', 'enterprise_id', 'team_id', 'installed_at'], name='slackbot_sl_client__90eca9_idx'),
        ),
    ]
